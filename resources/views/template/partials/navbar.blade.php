            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    ...
                    <div class="bg-light rounded-circle d-flex justify-content-center align-items-center"
                        ...
                        <i data-feather="user" class="text-secondary" style="width: 16px; height: 16px;"></i>
                    </div>
                </a>
                    ...
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <div class="bg-light rounded-circle d-flex justify-content-center align-items-center"
                                ...
                                <i data-feather="user" class="text-secondary" style="width: 40px; height: 40px;"></i>
                            </div>
                        </div>
                    ...
                    <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2">
                            <form method="POST" action="{{ route("logout") }}">
                                @csrf
                                <button type="submit" class="dropdown-item text-body ms-0"
